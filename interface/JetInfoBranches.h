...
class JetInfoBranches {
  ...
  public :
    ...
    float Jet_DeepDoubleBvLQCD[nMaxJets_];
    float Jet_DeepDoubleBvLHbb[nMaxJets_];
    float Jet_DeepDoubleCvLQCD[nMaxJets_];
    float Jet_DeepDoubleCvLHcc[nMaxJets_];
    float Jet_DeepDoubleCvBHcc[nMaxJets_];
    float Jet_DeepDoubleCvBHbb[nMaxJets_];
    float Jet_MassIndDeepDoubleBvLQCD[nMaxJets_];
    float Jet_MassIndDeepDoubleBvLHbb[nMaxJets_];
    float Jet_MassIndDeepDoubleCvLQCD[nMaxJets_];
    float Jet_MassIndDeepDoubleCvLHcc[nMaxJets_];
    float Jet_MassIndDeepDoubleCvBHcc[nMaxJets_];
    float Jet_MassIndDeepDoubleCvBHbb[nMaxJets_];
    ...
    float DeepDoubleXInput_jetNSecondaryVertices[nMaxJets_];
    float DeepDoubleXInput_trackSip3dSig_0[nMaxJets_];
    float DeepDoubleXInput_trackSip3dSig_1[nMaxJets_];
    float DeepDoubleXInput_trackSip3dSig_2[nMaxJets_];
    float DeepDoubleXInput_trackSip3dSig_3[nMaxJets_];
    float DeepDoubleXInput_tau1_trackSip3dSig_0[nMaxJets_];
    float DeepDoubleXInput_tau1_trackSip3dSig_1[nMaxJets_];
    float DeepDoubleXInput_tau2_trackSip3dSig_0[nMaxJets_];
    float DeepDoubleXInput_tau2_trackSip3dSig_1[nMaxJets_];
    float DeepDoubleXInput_trackSip2dSigAboveBottom_0[nMaxJets_];
    float DeepDoubleXInput_trackSip2dSigAboveBottom_1[nMaxJets_];
    float DeepDoubleXInput_trackSip2dSigAboveCharm[nMaxJets_];
    float DeepDoubleXInput_tau1_trackEtaRel_0[nMaxJets_];
    float DeepDoubleXInput_tau1_trackEtaRel_1[nMaxJets_];
    float DeepDoubleXInput_tau1_trackEtaRel_2[nMaxJets_];
    float DeepDoubleXInput_tau2_trackEtaRel_0[nMaxJets_];
    float DeepDoubleXInput_tau2_trackEtaRel_1[nMaxJets_];
    float DeepDoubleXInput_tau2_trackEtaRel_2[nMaxJets_];
    float DeepDoubleXInput_tau1_vertexMass[nMaxJets_];
    float DeepDoubleXInput_tau1_vertexEnergyRatio[nMaxJets_];
    float DeepDoubleXInput_tau1_flightDistance2dSig[nMaxJets_];
    float DeepDoubleXInput_tau1_vertexDeltaR[nMaxJets_];
    float DeepDoubleXInput_tau2_vertexMass[nMaxJets_];
    float DeepDoubleXInput_tau2_vertexEnergyRatio[nMaxJets_];
    float DeepDoubleXInput_tau2_flightDistance2dSig[nMaxJets_];
    float DeepDoubleXInput_tau2_vertexDeltaR[nMaxJets_];
    float DeepDoubleXInput_z_ratio[nMaxJets_];
    int   nTrkDeepDoubleX;
    int   Jet_DeepDoubleX_nFirstTrkTagVar[nMaxJets_];
    int   Jet_DeepDoubleX_nLastTrkTagVar[nMaxJets_];
    float DeepDoubleXInput_charged_EtaRel[nMaxTrk_];
    float DeepDoubleXInput_charged_PtRatio[nMaxTrk_];
    float DeepDoubleXInput_charged_PParRatio[nMaxTrk_];
    float DeepDoubleXInput_charged_Sip2dVal[nMaxTrk_];
    float DeepDoubleXInput_charged_Sip2dSig[nMaxTrk_];
    float DeepDoubleXInput_charged_Sip3dVal[nMaxTrk_];
    float DeepDoubleXInput_charged_Sip3dSig[nMaxTrk_];
    float DeepDoubleXInput_charged_JetDistVal[nMaxTrk_];
    int   nSVDeepDoubleX;
    int   Jet_DeepDoubleX_nFirstSVTagVar[nMaxJets_];
    int   Jet_DeepDoubleX_nLastSVTagVar[nMaxJets_];
    float DeepDoubleXInput_sv_d3d[nMaxSVs_];
    float DeepDoubleXInput_sv_d3dsig[nMaxSVs_];
    ...
    void RegisterBranches(TTree *tree, VariableParser variableParser, std::string name="") {
      ...
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_jetNSecondaryVertices")) tree->Branch((name+"DeepDoubleXInput_jetNSecondaryVertices").c_str()           ,&DeepDoubleXInput_jetNSecondaryVertices          ,(name+"DeepDoubleXInput_jetNSecondaryVertices["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_trackSip3dSig_0")) tree->Branch((name+"DeepDoubleXInput_trackSip3dSig_0").c_str()           ,&DeepDoubleXInput_trackSip3dSig_0          ,(name+"DeepDoubleXInput_trackSip3dSig_0["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_trackSip3dSig_1")) tree->Branch((name+"DeepDoubleXInput_trackSip3dSig_1").c_str()           ,&DeepDoubleXInput_trackSip3dSig_1          ,(name+"DeepDoubleXInput_trackSip3dSig_1["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_trackSip3dSig_2")) tree->Branch((name+"DeepDoubleXInput_trackSip3dSig_2").c_str()           ,&DeepDoubleXInput_trackSip3dSig_2          ,(name+"DeepDoubleXInput_trackSip3dSig_2["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_trackSip3dSig_3")) tree->Branch((name+"DeepDoubleXInput_trackSip3dSig_3").c_str()           ,&DeepDoubleXInput_trackSip3dSig_3          ,(name+"DeepDoubleXInput_trackSip3dSig_3["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_tau1_trackSip3dSig_0")) tree->Branch((name+"DeepDoubleXInput_tau1_trackSip3dSig_0").c_str()           ,&DeepDoubleXInput_tau1_trackSip3dSig_0          ,(name+"DeepDoubleXInput_tau1_trackSip3dSig_0["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_tau1_trackSip3dSig_1")) tree->Branch((name+"DeepDoubleXInput_tau1_trackSip3dSig_1").c_str()           ,&DeepDoubleXInput_tau1_trackSip3dSig_1          ,(name+"DeepDoubleXInput_tau1_trackSip3dSig_1["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_tau2_trackSip3dSig_0")) tree->Branch((name+"DeepDoubleXInput_tau2_trackSip3dSig_0").c_str()           ,&DeepDoubleXInput_tau2_trackSip3dSig_0          ,(name+"DeepDoubleXInput_tau2_trackSip3dSig_0["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_tau2_trackSip3dSig_1")) tree->Branch((name+"DeepDoubleXInput_tau2_trackSip3dSig_1").c_str()           ,&DeepDoubleXInput_tau2_trackSip3dSig_1          ,(name+"DeepDoubleXInput_tau2_trackSip3dSig_1["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_trackSip2dSigAboveBottom_0")) tree->Branch((name+"DeepDoubleXInput_trackSip2dSigAboveBottom_0").c_str()           ,&DeepDoubleXInput_trackSip2dSigAboveBottom_0          ,(name+"DeepDoubleXInput_trackSip2dSigAboveBottom_0["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_trackSip2dSigAboveBottom_1")) tree->Branch((name+"DeepDoubleXInput_trackSip2dSigAboveBottom_1").c_str()           ,&DeepDoubleXInput_trackSip2dSigAboveBottom_1          ,(name+"DeepDoubleXInput_trackSip2dSigAboveBottom_1["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_trackSip2dSigAboveCharm")) tree->Branch((name+"DeepDoubleXInput_trackSip2dSigAboveCharm").c_str()           ,&DeepDoubleXInput_trackSip2dSigAboveCharm          ,(name+"DeepDoubleXInput_trackSip2dSigAboveCharm["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_tau1_trackEtaRel_0")) tree->Branch((name+"DeepDoubleXInput_tau1_trackEtaRel_0").c_str()           ,&DeepDoubleXInput_tau1_trackEtaRel_0          ,(name+"DeepDoubleXInput_tau1_trackEtaRel_0["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_tau1_trackEtaRel_1")) tree->Branch((name+"DeepDoubleXInput_tau1_trackEtaRel_1").c_str()           ,&DeepDoubleXInput_tau1_trackEtaRel_1          ,(name+"DeepDoubleXInput_tau1_trackEtaRel_1["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_tau1_trackEtaRel_2")) tree->Branch((name+"DeepDoubleXInput_tau1_trackEtaRel_2").c_str()           ,&DeepDoubleXInput_tau1_trackEtaRel_2          ,(name+"DeepDoubleXInput_tau1_trackEtaRel_2["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_tau2_trackEtaRel_0")) tree->Branch((name+"DeepDoubleXInput_tau2_trackEtaRel_0").c_str()           ,&DeepDoubleXInput_tau2_trackEtaRel_0          ,(name+"DeepDoubleXInput_tau2_trackEtaRel_0["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_tau2_trackEtaRel_1")) tree->Branch((name+"DeepDoubleXInput_tau2_trackEtaRel_1").c_str()           ,&DeepDoubleXInput_tau2_trackEtaRel_1          ,(name+"DeepDoubleXInput_tau2_trackEtaRel_1["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_tau2_trackEtaRel_2")) tree->Branch((name+"DeepDoubleXInput_tau2_trackEtaRel_2").c_str()           ,&DeepDoubleXInput_tau2_trackEtaRel_2          ,(name+"DeepDoubleXInput_tau2_trackEtaRel_2["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_tau1_vertexMass")) tree->Branch((name+"DeepDoubleXInput_tau1_vertexMass").c_str()           ,&DeepDoubleXInput_tau1_vertexMass          ,(name+"DeepDoubleXInput_tau1_vertexMass["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_tau1_vertexEnergyRatio")) tree->Branch((name+"DeepDoubleXInput_tau1_vertexEnergyRatio").c_str()           ,&DeepDoubleXInput_tau1_vertexEnergyRatio          ,(name+"DeepDoubleXInput_tau1_vertexEnergyRatio["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_tau1_flightDistance2dSig")) tree->Branch((name+"DeepDoubleXInput_tau1_flightDistance2dSig").c_str()           ,&DeepDoubleXInput_tau1_flightDistance2dSig          ,(name+"DeepDoubleXInput_tau1_flightDistance2dSig["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_tau1_vertexDeltaR")) tree->Branch((name+"DeepDoubleXInput_tau1_vertexDeltaR").c_str()           ,&DeepDoubleXInput_tau1_vertexDeltaR          ,(name+"DeepDoubleXInput_tau1_vertexDeltaR["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_tau2_vertexMass")) tree->Branch((name+"DeepDoubleXInput_tau2_vertexMass").c_str()           ,&DeepDoubleXInput_tau2_vertexMass          ,(name+"DeepDoubleXInput_tau2_vertexMass["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_tau2_vertexEnergyRatio")) tree->Branch((name+"DeepDoubleXInput_tau2_vertexEnergyRatio").c_str()           ,&DeepDoubleXInput_tau2_vertexEnergyRatio          ,(name+"DeepDoubleXInput_tau2_vertexEnergyRatio["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_tau2_flightDistance2dSig")) tree->Branch((name+"DeepDoubleXInput_tau2_flightDistance2dSig").c_str()           ,&DeepDoubleXInput_tau2_flightDistance2dSig          ,(name+"DeepDoubleXInput_tau2_flightDistance2dSig["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_tau2_vertexDeltaR")) tree->Branch((name+"DeepDoubleXInput_tau2_vertexDeltaR").c_str()           ,&DeepDoubleXInput_tau2_vertexDeltaR          ,(name+"DeepDoubleXInput_tau2_vertexDeltaR["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_z_ratio")) tree->Branch((name+"DeepDoubleXInput_z_ratio").c_str()           ,&DeepDoubleXInput_z_ratio          ,(name+"DeepDoubleXInput_z_ratio["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"nTrkDeepDoubleX")) tree->Branch((name+"nTrkDeepDoubleX").c_str()           ,&nTrkDeepDoubleX          ,(name+"nTrkDeepDoubleX/I").c_str());
      if(variableParser.isToBeStored(name+"Jet_DeepDoubleX_nFirstTrkTagVar")) tree->Branch((name+"Jet_DeepDoubleX_nFirstTrkTagVar").c_str() ,Jet_DeepDoubleX_nFirstTrkTagVar  ,(name+"Jet_DeepDoubleX_nFirstTrkTagVar["+name+"nJet]/I").c_str() );
      if(variableParser.isToBeStored(name+"Jet_DeepDoubleX_nLastTrkTagVar")) tree->Branch((name+"Jet_DeepDoubleX_nLastTrkTagVar").c_str()   ,Jet_DeepDoubleX_nLastTrkTagVar   ,(name+"Jet_DeepDoubleX_nLastTrack["+name+"nJet]/I").c_str()      );
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_charged_EtaRel")) tree->Branch((name+"DeepDoubleXInput_charged_EtaRel").c_str(), DeepDoubleXInput_charged_EtaRel, (name+"DeepDoubleXInput_charged_EtaRel["+name+"nTrkDeepDoubleX]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_charged_PtRatio")) tree->Branch((name+"DeepDoubleXInput_charged_PtRatio").c_str(), DeepDoubleXInput_charged_PtRatio, (name+"DeepDoubleXInput_charged_PtRatio["+name+"nTrkDeepDoubleX]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_charged_PParRatio")) tree->Branch((name+"DeepDoubleXInput_charged_PParRatio").c_str(), DeepDoubleXInput_charged_PParRatio, (name+"DeepDoubleXInput_charged_PParRatio["+name+"nTrkDeepDoubleX]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_charged_Sip2dVal")) tree->Branch((name+"DeepDoubleXInput_charged_Sip2dVal").c_str(), DeepDoubleXInput_charged_Sip2dVal, (name+"DeepDoubleXInput_charged_Sip2dVal["+name+"nTrkDeepDoubleX]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_charged_Sip2dSig")) tree->Branch((name+"DeepDoubleXInput_charged_Sip2dSig").c_str(), DeepDoubleXInput_charged_Sip2dSig, (name+"DeepDoubleXInput_charged_Sip2dSig["+name+"nTrkDeepDoubleX]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_charged_Sip3dVal")) tree->Branch((name+"DeepDoubleXInput_charged_Sip3dVal").c_str(), DeepDoubleXInput_charged_Sip3dVal, (name+"DeepDoubleXInput_charged_Sip3dVal["+name+"nTrkDeepDoubleX]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_charged_Sip3dSig")) tree->Branch((name+"DeepDoubleXInput_charged_Sip3dSig").c_str(), DeepDoubleXInput_charged_Sip3dSig, (name+"DeepDoubleXInput_charged_Sip3dSig["+name+"nTrkDeepDoubleX]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_charged_JetDistVal")) tree->Branch((name+"DeepDoubleXInput_charged_JetDistVal").c_str(), DeepDoubleXInput_charged_JetDistVal, (name+"DeepDoubleXInput_charged_JetDistVal["+name+"nTrkDeepDoubleX]/F").c_str());

      if(variableParser.isToBeStored(name+"nSVDeepDoubleX")) tree->Branch((name+"nSVDeepDoubleX").c_str()           ,&nSVDeepDoubleX          ,(name+"nSVDeepDoubleX/I").c_str());
      if(variableParser.isToBeStored(name+"Jet_DeepDoubleX_nFirstSVTagVar")) tree->Branch((name+"Jet_DeepDoubleX_nFirstSVTagVar").c_str()   ,Jet_DeepDoubleX_nFirstSVTagVar   ,(name+"Jet_DeepDoubleX_nFirstSVTagVar["+name+"nJet]/I").c_str()  );
      if(variableParser.isToBeStored(name+"Jet_DeepDoubleX_nLastSVTagVar")) tree->Branch((name+"Jet_DeepDoubleX_nLastSVTagVar").c_str()    ,Jet_DeepDoubleX_nLastSVTagVar    ,(name+"Jet_DeepDoubleX_nLastSVTagVar["+name+"nJet]/I").c_str()   );
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_sv_d3d")) tree->Branch((name+"DeepDoubleXInput_sv_d3d").c_str()	, DeepDoubleXInput_sv_d3d, (name+"DeepDoubleXInput_sv_d3d["+name+"nSVDeepDoubleX]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepDoubleXInput_sv_d3dsig")) tree->Branch((name+"DeepDoubleXInput_sv_d3dsig").c_str(), DeepDoubleXInput_sv_d3dsig, (name+"DeepDoubleXInput_sv_d3dsig["+name+"nSVDeepDoubleX]/F").c_str());

      ////// DeepBoostedJet
      //
      if(variableParser.isToBeStored(name+"nTrkDeepBoostedJet")) tree->Branch((name+"nTrkDeepBoostedJet").c_str()           ,&nTrkDeepBoostedJet          ,(name+"nTrkDeepBoostedJet/I").c_str());
      if(variableParser.isToBeStored(name+"Jet_DeepBoostedJet_nFirstTrkTagVar")) tree->Branch((name+"Jet_DeepBoostedJet_nFirstTrkTagVar").c_str() ,Jet_DeepBoostedJet_nFirstTrkTagVar  ,(name+"Jet_DeepBoostedJet_nFirstTrkTagVar["+name+"nJet]/I").c_str() );
      if(variableParser.isToBeStored(name+"Jet_DeepBoostedJet_nLastTrkTagVar")) tree->Branch((name+"Jet_DeepBoostedJet_nLastTrkTagVar").c_str()   ,Jet_DeepBoostedJet_nLastTrkTagVar   ,(name+"Jet_DeepBoostedJet_nLastTrack["+name+"nJet]/I").c_str()      );
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_puppiw")) tree->Branch((name+"DeepBoostedJetInput_pf_puppiw").c_str(), DeepBoostedJetInput_pf_puppiw, (name+"DeepBoostedJetInput_pf_puppiw["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_hcalFrac")) tree->Branch((name+"DeepBoostedJetInput_pf_hcalFrac").c_str(), DeepBoostedJetInput_pf_hcalFrac, (name+"DeepBoostedJetInput_pf_hcalFrac["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_VTX_ass")) tree->Branch((name+"DeepBoostedJetInput_pf_VTX_ass").c_str(), DeepBoostedJetInput_pf_VTX_ass, (name+"DeepBoostedJetInput_pf_VTX_ass["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_lostInnerHits")) tree->Branch((name+"DeepBoostedJetInput_pf_lostInnerHits").c_str(), DeepBoostedJetInput_pf_lostInnerHits, (name+"DeepBoostedJetInput_pf_lostInnerHits["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_quality")) tree->Branch((name+"DeepBoostedJetInput_pf_quality").c_str(), DeepBoostedJetInput_pf_quality, (name+"DeepBoostedJetInput_pf_quality["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_charge")) tree->Branch((name+"DeepBoostedJetInput_pf_charge").c_str(), DeepBoostedJetInput_pf_charge, (name+"DeepBoostedJetInput_pf_charge["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_isEl")) tree->Branch((name+"DeepBoostedJetInput_pf_isEl").c_str(), DeepBoostedJetInput_pf_isEl, (name+"DeepBoostedJetInput_pf_isEl["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_isMu")) tree->Branch((name+"DeepBoostedJetInput_pf_isMu").c_str(), DeepBoostedJetInput_pf_isMu, (name+"DeepBoostedJetInput_pf_isMu["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_isChargedHad")) tree->Branch((name+"DeepBoostedJetInput_pf_isChargedHad").c_str(), DeepBoostedJetInput_pf_isChargedHad, (name+"DeepBoostedJetInput_pf_isChargedHad["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_isGamma")) tree->Branch((name+"DeepBoostedJetInput_pf_isGamma").c_str(), DeepBoostedJetInput_pf_isGamma, (name+"DeepBoostedJetInput_pf_isGamma["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_isNeutralHad")) tree->Branch((name+"DeepBoostedJetInput_pf_isNeutralHad").c_str(), DeepBoostedJetInput_pf_isNeutralHad, (name+"DeepBoostedJetInput_pf_isNeutralHad["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_phirel")) tree->Branch((name+"DeepBoostedJetInput_pf_phirel").c_str(), DeepBoostedJetInput_pf_phirel, (name+"DeepBoostedJetInput_pf_phirel["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_etarel")) tree->Branch((name+"DeepBoostedJetInput_pf_etarel").c_str(), DeepBoostedJetInput_pf_etarel, (name+"DeepBoostedJetInput_pf_etarel["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_deltaR")) tree->Branch((name+"DeepBoostedJetInput_pf_deltaR").c_str(), DeepBoostedJetInput_pf_deltaR, (name+"DeepBoostedJetInput_pf_deltaR["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_abseta")) tree->Branch((name+"DeepBoostedJetInput_pf_abseta").c_str(), DeepBoostedJetInput_pf_abseta, (name+"DeepBoostedJetInput_pf_abseta["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_ptrel_log")) tree->Branch((name+"DeepBoostedJetInput_pf_ptrel_log").c_str(), DeepBoostedJetInput_pf_ptrel_log, (name+"DeepBoostedJetInput_pf_ptrel_log["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_erel_log")) tree->Branch((name+"DeepBoostedJetInput_pf_erel_log").c_str(), DeepBoostedJetInput_pf_erel_log, (name+"DeepBoostedJetInput_pf_erel_log["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_pt_log")) tree->Branch((name+"DeepBoostedJetInput_pf_pt_log").c_str(), DeepBoostedJetInput_pf_pt_log, (name+"DeepBoostedJetInput_pf_pt_log["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_drminsv")) tree->Branch((name+"DeepBoostedJetInput_pf_drminsv").c_str(), DeepBoostedJetInput_pf_drminsv, (name+"DeepBoostedJetInput_pf_drminsv["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_drsubjet1")) tree->Branch((name+"DeepBoostedJetInput_pf_drsubjet1").c_str(), DeepBoostedJetInput_pf_drsubjet1, (name+"DeepBoostedJetInput_pf_drsubjet1["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_drsubjet2")) tree->Branch((name+"DeepBoostedJetInput_pf_drsubjet2").c_str(), DeepBoostedJetInput_pf_drsubjet2, (name+"DeepBoostedJetInput_pf_drsubjet2["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_normchi2")) tree->Branch((name+"DeepBoostedJetInput_pf_normchi2").c_str(), DeepBoostedJetInput_pf_normchi2, (name+"DeepBoostedJetInput_pf_normchi2["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_dz")) tree->Branch((name+"DeepBoostedJetInput_pf_dz").c_str(), DeepBoostedJetInput_pf_dz, (name+"DeepBoostedJetInput_pf_dz["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_dzsig")) tree->Branch((name+"DeepBoostedJetInput_pf_dzsig").c_str(), DeepBoostedJetInput_pf_dzsig, (name+"DeepBoostedJetInput_pf_dzsig["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_dxy")) tree->Branch((name+"DeepBoostedJetInput_pf_dxy").c_str(), DeepBoostedJetInput_pf_dxy, (name+"DeepBoostedJetInput_pf_dxy["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_dxysig")) tree->Branch((name+"DeepBoostedJetInput_pf_dxysig").c_str(), DeepBoostedJetInput_pf_dxysig, (name+"DeepBoostedJetInput_pf_dxysig["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_dptdpt")) tree->Branch((name+"DeepBoostedJetInput_pf_dptdpt").c_str(), DeepBoostedJetInput_pf_dptdpt, (name+"DeepBoostedJetInput_pf_dptdpt["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_detadeta")) tree->Branch((name+"DeepBoostedJetInput_pf_detadeta").c_str(), DeepBoostedJetInput_pf_detadeta, (name+"DeepBoostedJetInput_pf_detadeta["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_dphidphi")) tree->Branch((name+"DeepBoostedJetInput_pf_dphidphi").c_str(), DeepBoostedJetInput_pf_dphidphi, (name+"DeepBoostedJetInput_pf_dphidphi["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_dxydxy")) tree->Branch((name+"DeepBoostedJetInput_pf_dxydxy").c_str(), DeepBoostedJetInput_pf_dxydxy, (name+"DeepBoostedJetInput_pf_dxydxy["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_dlambdadz")) tree->Branch((name+"DeepBoostedJetInput_pf_dlambdadz").c_str(), DeepBoostedJetInput_pf_dlambdadz, (name+"DeepBoostedJetInput_pf_dlambdadz["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_btagEtaRel")) tree->Branch((name+"DeepBoostedJetInput_pf_btagEtaRel").c_str(), DeepBoostedJetInput_pf_btagEtaRel, (name+"DeepBoostedJetInput_pf_btagEtaRel["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_btagPtRatio")) tree->Branch((name+"DeepBoostedJetInput_pf_btagPtRatio").c_str(), DeepBoostedJetInput_pf_btagPtRatio, (name+"DeepBoostedJetInput_pf_btagPtRatio["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_btagPParRatio")) tree->Branch((name+"DeepBoostedJetInput_pf_btagPParRatio").c_str(), DeepBoostedJetInput_pf_btagPParRatio, (name+"DeepBoostedJetInput_pf_btagPParRatio["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_btagSip2dVal")) tree->Branch((name+"DeepBoostedJetInput_pf_btagSip2dVal").c_str(), DeepBoostedJetInput_pf_btagSip2dVal, (name+"DeepBoostedJetInput_pf_btagSip2dVal["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_btagSip2dSig")) tree->Branch((name+"DeepBoostedJetInput_pf_btagSip2dSig").c_str(), DeepBoostedJetInput_pf_btagSip2dSig, (name+"DeepBoostedJetInput_pf_btagSip2dSig["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_btagSip3dVal")) tree->Branch((name+"DeepBoostedJetInput_pf_btagSip3dVal").c_str(), DeepBoostedJetInput_pf_btagSip3dVal, (name+"DeepBoostedJetInput_pf_btagSip3dVal["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_btagSip3dSig")) tree->Branch((name+"DeepBoostedJetInput_pf_btagSip3dSig").c_str(), DeepBoostedJetInput_pf_btagSip3dSig, (name+"DeepBoostedJetInput_pf_btagSip3dSig["+name+"nTrkDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_pf_btagJetDistVal")) tree->Branch((name+"DeepBoostedJetInput_pf_btagJetDistVal").c_str(), DeepBoostedJetInput_pf_btagJetDistVal, (name+"DeepBoostedJetInput_pf_btagJetDistVal["+name+"nTrkDeepBoostedJet]/F").c_str());

      if(variableParser.isToBeStored(name+"nSVDeepBoostedJet")) tree->Branch((name+"nSVDeepBoostedJet").c_str()           ,&nSVDeepBoostedJet          ,(name+"nSVDeepBoostedJet/I").c_str());
      if(variableParser.isToBeStored(name+"Jet_DeepBoostedJet_nFirstSVTagVar")) tree->Branch((name+"Jet_DeepBoostedJet_nFirstSVTagVar").c_str()   ,Jet_DeepBoostedJet_nFirstSVTagVar   ,(name+"Jet_DeepBoostedJet_nFirstSVTagVar["+name+"nJet]/I").c_str()  );
      if(variableParser.isToBeStored(name+"Jet_DeepBoostedJet_nLastSVTagVar")) tree->Branch((name+"Jet_DeepBoostedJet_nLastSVTagVar").c_str()    ,Jet_DeepBoostedJet_nLastSVTagVar    ,(name+"Jet_DeepBoostedJet_nLastSVTagVar["+name+"nJet]/I").c_str()   );
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_sv_phirel")) tree->Branch((name+"DeepBoostedJetInput_sv_phirel").c_str()	, DeepBoostedJetInput_sv_phirel, (name+"DeepBoostedJetInput_sv_phirel["+name+"nSVDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_sv_etarel")) tree->Branch((name+"DeepBoostedJetInput_sv_etarel").c_str()	, DeepBoostedJetInput_sv_etarel, (name+"DeepBoostedJetInput_sv_etarel["+name+"nSVDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_sv_deltaR")) tree->Branch((name+"DeepBoostedJetInput_sv_deltaR").c_str()	, DeepBoostedJetInput_sv_deltaR, (name+"DeepBoostedJetInput_sv_deltaR["+name+"nSVDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_sv_abseta")) tree->Branch((name+"DeepBoostedJetInput_sv_abseta").c_str()	, DeepBoostedJetInput_sv_abseta, (name+"DeepBoostedJetInput_sv_abseta["+name+"nSVDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_sv_mass")) tree->Branch((name+"DeepBoostedJetInput_sv_mass").c_str()	, DeepBoostedJetInput_sv_mass, (name+"DeepBoostedJetInput_sv_mass["+name+"nSVDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_sv_ptrel_log")) tree->Branch((name+"DeepBoostedJetInput_sv_ptrel_log").c_str()	, DeepBoostedJetInput_sv_ptrel_log, (name+"DeepBoostedJetInput_sv_ptrel_log["+name+"nSVDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_sv_erel_log")) tree->Branch((name+"DeepBoostedJetInput_sv_erel_log").c_str()	, DeepBoostedJetInput_sv_erel_log, (name+"DeepBoostedJetInput_sv_erel_log["+name+"nSVDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_sv_pt_log")) tree->Branch((name+"DeepBoostedJetInput_sv_pt_log").c_str()	, DeepBoostedJetInput_sv_pt_log, (name+"DeepBoostedJetInput_sv_pt_log["+name+"nSVDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_sv_ntracks")) tree->Branch((name+"DeepBoostedJetInput_sv_ntracks").c_str()	, DeepBoostedJetInput_sv_ntracks, (name+"DeepBoostedJetInput_sv_ntracks["+name+"nSVDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_sv_normchi2")) tree->Branch((name+"DeepBoostedJetInput_sv_normchi2").c_str()	, DeepBoostedJetInput_sv_normchi2, (name+"DeepBoostedJetInput_sv_normchi2["+name+"nSVDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_sv_dxy")) tree->Branch((name+"DeepBoostedJetInput_sv_dxy").c_str()	, DeepBoostedJetInput_sv_dxy, (name+"DeepBoostedJetInput_sv_dxy["+name+"nSVDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_sv_dxysig")) tree->Branch((name+"DeepBoostedJetInput_sv_dxysig").c_str()	, DeepBoostedJetInput_sv_dxysig, (name+"DeepBoostedJetInput_sv_dxysig["+name+"nSVDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_sv_d3d")) tree->Branch((name+"DeepBoostedJetInput_sv_d3d").c_str()	, DeepBoostedJetInput_sv_d3d, (name+"DeepBoostedJetInput_sv_d3d["+name+"nSVDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_sv_d3dsig")) tree->Branch((name+"DeepBoostedJetInput_sv_d3dsig").c_str()	, DeepBoostedJetInput_sv_d3dsig, (name+"DeepBoostedJetInput_sv_d3dsig["+name+"nSVDeepBoostedJet]/F").c_str());
      if(variableParser.isToBeStored(name+"DeepBoostedJetInput_sv_costhetasvpv")) tree->Branch((name+"DeepBoostedJetInput_sv_costhetasvpv").c_str()	, DeepBoostedJetInput_sv_costhetasvpv, (name+"DeepBoostedJetInput_sv_costhetasvpv["+name+"nSVDeepBoostedJet]/F").c_str());
      ...
      if(variableParser.isToBeStored(name+"Jet_DeepDoubleBvLQCD")) tree->Branch((name+"Jet_DeepDoubleBvLQCD").c_str(),      Jet_DeepDoubleBvLQCD      ,(name+"Jet_DeepDoubleBvLQCD["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"Jet_DeepDoubleBvLHbb")) tree->Branch((name+"Jet_DeepDoubleBvLHbb").c_str(),      Jet_DeepDoubleBvLHbb      ,(name+"Jet_DeepDoubleBvLHbb["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"Jet_DeepDoubleCvLQCD")) tree->Branch((name+"Jet_DeepDoubleCvLQCD").c_str(),      Jet_DeepDoubleCvLQCD      ,(name+"Jet_DeepDoubleCvLQCD["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"Jet_DeepDoubleCvLHcc")) tree->Branch((name+"Jet_DeepDoubleCvLHcc").c_str(),      Jet_DeepDoubleCvLHcc      ,(name+"Jet_DeepDoubleCvLHcc["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"Jet_DeepDoubleCvBHcc")) tree->Branch((name+"Jet_DeepDoubleCvBHcc").c_str(),      Jet_DeepDoubleCvBHcc      ,(name+"Jet_DeepDoubleCvBHcc["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"Jet_DeepDoubleCvBHbb")) tree->Branch((name+"Jet_DeepDoubleCvBHbb").c_str(),      Jet_DeepDoubleCvBHbb      ,(name+"Jet_DeepDoubleCvBHbb["+name+"nJet]/F").c_str());

      if(variableParser.isToBeStored(name+"Jet_MassIndDeepDoubleBvLQCD")) tree->Branch((name+"Jet_MassIndDeepDoubleBvLQCD").c_str(),      Jet_MassIndDeepDoubleBvLQCD      ,(name+"Jet_MassIndDeepDoubleBvLQCD["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"Jet_MassIndDeepDoubleBvLHbb")) tree->Branch((name+"Jet_MassIndDeepDoubleBvLHbb").c_str(),      Jet_MassIndDeepDoubleBvLHbb      ,(name+"Jet_MassIndDeepDoubleBvLHbb["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"Jet_MassIndDeepDoubleCvLQCD")) tree->Branch((name+"Jet_MassIndDeepDoubleCvLQCD").c_str(),      Jet_MassIndDeepDoubleCvLQCD      ,(name+"Jet_MassIndDeepDoubleCvLQCD["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"Jet_MassIndDeepDoubleCvLHcc")) tree->Branch((name+"Jet_MassIndDeepDoubleCvLHcc").c_str(),      Jet_MassIndDeepDoubleCvLHcc      ,(name+"Jet_MassIndDeepDoubleCvLHcc["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"Jet_MassIndDeepDoubleCvBHcc")) tree->Branch((name+"Jet_MassIndDeepDoubleCvBHcc").c_str(),      Jet_MassIndDeepDoubleCvBHcc      ,(name+"Jet_MassIndDeepDoubleCvBHcc["+name+"nJet]/F").c_str());
      if(variableParser.isToBeStored(name+"Jet_MassIndDeepDoubleCvBHbb")) tree->Branch((name+"Jet_MassIndDeepDoubleCvBHbb").c_str(),      Jet_MassIndDeepDoubleCvBHbb      ,(name+"Jet_MassIndDeepDoubleCvBHbb["+name+"nJet]/F").c_str());
