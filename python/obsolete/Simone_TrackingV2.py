...
# with command line options: step3 --conditions auto:phase2_realistic_T14 -n 10 --era Phase2C8 --no_output --runUnscheduled -s RAW2DIGI,L1Reco,RECO,RECOSIM --geometry Extended2023D41 --no_exec
